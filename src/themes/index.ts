...
export const themes: ThemeEntry[] = [
  {
    ...
    description: 'Pong buttons. Star inputs. Spiral outlines. Still just a theme that looks EXACTLY like Google!',
  },
  {
    id: 'ios1',
    label: 'iPhone OS 1.0',
    theme: ios1Theme,
    description: 'Wet-glass buttons, inset inputs, Helvetica Neue. Slide to unlock not included. (I guess they had MUI in 2007.)',
  },
  {
    id: 'unstyled',
    label: 'Unstyled HTML',
  ...
  },
  {
    ...
    label: 'Windows 95',
    theme: win95Theme,
    description: 'Silver. Sunken inputs. Raised buttons. All via theme. Please set your wallpaper to teal and prepare to feast your eyes on Google 95.',
  },
  {
    id: 'shadcn',
    label: 'shadcn/ui',
    theme: shadcnTheme,
    description: 'Zinc. Inter. Dark ring. The "no more MUI" rewrite, built entirely in MUI. Still looks like Google.',
  },
  {
    id: 'default',
    label: 'Default',
